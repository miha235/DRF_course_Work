...
def urlparse(url: str = "", **kwargs: str | None) -> ParseResult:
    ...
    parsed_query: str | None = None if query is None else quote(
        query, safe=QUERY_SAFE)
    parsed_frag: str | None = None if frag is None else quote(
        frag, safe=FRAG_SAFE)
...
def percent_encoded(string: str, safe: str) -> str:
    ...
    return "".join(
        [char if char in NON_ESCAPED_CHARS else PERCENT(
