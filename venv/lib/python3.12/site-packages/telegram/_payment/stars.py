...
class RevenueWithdrawalStateSucceeded(RevenueWithdrawalState):
    ...
    def de_json(
        ...
        data["date"] = from_timestamp(
            data.get("date", None), tzinfo=loc_tzinfo)
...
class TransactionPartner(TelegramObject):
    ...
    * :class:`TransactionPartnerOther`
    ...
    def __init__(self, type: str, *, api_kwargs: Optional[JSONDict] = None) -> None:
        super().__init__(api_kwargs=api_kwargs)
        self.type: str = enum.get_member(
            constants.TransactionPartnerType, type, type)
    ...
    def __init__(
        ...
        *,
        ...
        with self._unfrozen():
            ...
            self.paid_media: Optional[Tuple[PaidMedia, ...]
                                      ] = parse_sequence_arg(paid_media)
...
class StarTransaction(TelegramObject):
    ...
    def de_json(
        ...
        data["receiver"] = TransactionPartner.de_json(
            data.get("receiver"), bot)
...
class StarTransactions(TelegramObject):
    ...
    def de_json(
        ...
        data["transactions"] = StarTransaction.de_list(
            data.get("transactions"), bot)
        return super().de_json(data=data, bot=bot)
