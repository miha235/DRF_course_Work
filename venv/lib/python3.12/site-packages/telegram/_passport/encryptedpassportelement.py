...
class EncryptedPassportElement(TelegramObject):
    ...
    def __init__(
        ...
        data: Optional[Union[PersonalDetails,
            IdDocumentData, ResidentialAddress]] = None,
        ...
        *,
        ...
        self.type: str = type
        # Optionals
        self.data: Optional[Union[PersonalDetails,
                                  IdDocumentData, ResidentialAddress]] = data
