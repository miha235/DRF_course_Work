...
class JobQueue(Generic[CCT]):
    ...
    def _parse_time_input(
        self, time: None, shift_day: bool = False) -> None: ...
    ...
    def run_once(
        ...
        job = Job(callback=callback, data=data, name=name,
    ...
    def run_repeating(
        ...
        first: Optional[Union[float, datetime.timedelta,
                              datetime.datetime, datetime.time]] = None,
        last: Optional[Union[float, datetime.timedelta,
                             datetime.datetime, datetime.time]] = None,
        data: Optional[object] = None,
        name: Optional[str] = None,
        chat_id: Optional[int] = None,
    ...
    def run_custom(
        ...
        j = self.scheduler.add_job(self.job_callback, args=(
            self, job), name=name, **job_kwargs)
