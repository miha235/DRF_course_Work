...
class ApplicationBuilder(Generic[BT, CCT, UD, CD, BD, JQ]):
    ...
    def __init__(self: "InitApplicationBuilder"):
        ...
        self._get_updates_proxy: DVInput[Union[str,
                                               httpx.Proxy, httpx.URL]] = DEFAULT_NONE
        self._get_updates_socket_options: DVInput[Collection[SocketOpt]
                                                  ] = DEFAULT_NONE
        ...
        self._update_queue: DVType[Queue[Union[Update, object]]] = DefaultValue(
            Queue())
    ...
    def _build_request(self, get_updates: bool) -> BaseRequest:
        ...
        http_version = DefaultValue.get_value(
            getattr(self, f"{prefix}http_version")) or "1.1"
    ...
    def _request_check(self, get_updates: bool) -> None:
        ...
        if not isinstance(getattr(self, f"_{prefix}connection_pool_size"), DefaultValue):
            raise RuntimeError(_TWO_ARGS_REQ.format(
    ...
    def connection_pool_size(self: BuilderType, connection_pool_size: int) -> BuilderType:
        ...
        self._request_param_check(
            name="connection_pool_size", get_updates=False)
    ...
    def media_write_timeout(
        ...
        """
        self._request_param_check(
            name="media_write_timeout", get_updates=False)
    ...
    def get_updates_connection_pool_size(
        ...
        """
        self._request_param_check(
            name="connection_pool_size", get_updates=True)
    ...
    def private_key(
        ...
        self._private_key = (
            private_key if isinstance(private_key, bytes) else Path(
