...
class Mention(MessageFilter):
    ...
    def __init__(self, mentions: SCT[Union[int, str, TGUser]]):
        ...
        if isinstance(mentions, Iterable) and not isinstance(mentions, str):
            self._mentions = {self._fix_mention_username(
...
class StatusUpdate:
    ...
    GIVEAWAY_CREATED = _GiveawayCreated(
        name="filters.StatusUpdate.GIVEAWAY_CREATED")
    ...
    REFUNDED_PAYMENT = _RefundedPayment(
...
class UpdateType:
    ...
    BUSINESS_MESSAGE = _BusinessMessage(
        name="filters.UpdateType.BUSINESS_MESSAGE")
    ...
    BUSINESS_MESSAGES = _BusinessMessages(
        name="filters.UpdateType.BUSINESS_MESSAGES")
