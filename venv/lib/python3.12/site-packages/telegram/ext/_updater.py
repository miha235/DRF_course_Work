...
_UpdaterType = TypeVar(
    "_UpdaterType", bound="Updater")  # pylint: disable=invalid-name
...
class Updater(AsyncContextManager["Updater"]):
    ...
    def __init__(
        ...
        self.__polling_cleanup_cb: Optional[Callable[[
    ...
    async def _start_webhook(
        ...
        app = WebhookAppClass(url_path, self.bot,
                              self.update_queue, secret_token)
