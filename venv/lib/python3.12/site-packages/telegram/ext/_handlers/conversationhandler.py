...
_CheckUpdateType = Tuple[object, ConversationKey,
                         BaseHandler[Update, CCT, object], object]
...
class ConversationHandler(BaseHandler[Update, CCT, object]):
    ...
    def __init__(
        ...
        conversation_timeout: Optional[Union[float,
        ...
        self._entry_points: List[BaseHandler[Update,
                                             CCT, object]] = entry_points
        self._states: Dict[object,
                           List[BaseHandler[Update, CCT, object]]] = states
    ...
    def check_update(self, update: object) -> Optional[_CheckUpdateType[CCT]]:
        ...
        _LOGGER.debug("Selecting conversation %s with state %s",
                      str(key), str(state))
        ...
        async with self._timeout_jobs_lock:
            if self.conversation_timeout:
                if application.job_queue is None:
                    ...
                    self._schedule_job(new_state, application,
                                       update, context, conversation_key)
