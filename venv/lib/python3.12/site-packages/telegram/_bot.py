...
class Bot(TelegramObject, AsyncContextManager["Bot"]):
    ...
    async def _do_post(
        ...
        *,
        ...
        request_data = RequestData(
            parameters=[RequestParameter.from_input(
    ...
    def _effective_inline_results(
        ...
        if current_offset is not None:
            ...
            current_offset_int = 0 if not current_offset else int(
                current_offset)
    ...
    async def get_updates(
        ...
        *,
        ...
        if result:
            self._LOGGER.debug("Getting updates: %s", [
    ...
    async def send_invoice(
        ...
        description: str,
        payload: str,
        # This arg is now optional as of Bot API 7.4
...
CUSTOM_EMOJI_IDENTIFIER_LIMIT` custom emoji identifiers can be specified.
    ...
    async def set_my_commands(
        ...
        *,
        ...
        """
        cmds = [c if isinstance(c, BotCommand) else BotCommand(
            c[0], c[1]) for c in commands]
    ...
    async def set_my_description(
        ...
        *,
        ...
        """
        data: JSONDict = {"description": description,
    ...
    async def set_message_reaction(
        ...
        chat_id: Union[str, int],
        message_id: int,
        reaction: Optional[Union[Sequence[Union[ReactionType,
                                                str]], ReactionType, str]] = None,
        ...
        *,
        ...
        parsed_reaction = (
            [
                ...
                for entry in (
                    [reaction] if isinstance(
                        reaction, (ReactionType, str)) else reaction
                )
            ]
