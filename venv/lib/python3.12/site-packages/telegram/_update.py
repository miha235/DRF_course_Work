...
class Update(TelegramObject):
    ...
    def de_json(cls, data: Optional[JSONDict], bot: Optional["Bot"] = None) -> Optional["Update"]:
        ...
        data["chat_boost"] = ChatBoostUpdated.de_json(
            data.get("chat_boost"), bot)
        data["removed_chat_boost"] = ChatBoostRemoved.de_json(
            data.get("removed_chat_boost"), bot)
        ...
        data["business_message"] = Message.de_json(
            data.get("business_message"), bot)
        data["edited_business_message"] = Message.de_json(
            data.get("edited_business_message"), bot)
