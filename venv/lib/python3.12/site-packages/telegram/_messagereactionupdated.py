...
class MessageReactionCountUpdated(TelegramObject):
    ...
    def __init__(
        ...
        *,
        ...
        self.reactions: Tuple[ReactionCount, ...] = parse_sequence_arg(
            reactions)

        self._id_attrs = (self.chat, self.message_id,
                          self.date, self.reactions)
        self._freeze()
...
class MessageReactionUpdated(TelegramObject):
    ...
    def __init__(
        ...
        *,
        ...
        self.message_id: int = message_id
        self.date: datetime = date
        self.old_reaction: Tuple[ReactionType, ...] = parse_sequence_arg(
            old_reaction)
        self.new_reaction: Tuple[ReactionType, ...] = parse_sequence_arg(
            new_reaction)
    ...
    def de_json(
        ...
        data["date"] = from_timestamp(data.get("date"), tzinfo=loc_tzinfo)
        data["chat"] = Chat.de_json(data.get("chat"), bot)
        data["old_reaction"] = ReactionType.de_list(
            data.get("old_reaction"), bot)
        data["new_reaction"] = ReactionType.de_list(
            data.get("new_reaction"), bot)
