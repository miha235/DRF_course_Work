...
class ChatBoostSource(TelegramObject):
    ...
    * :class:`telegram.ChatBoostSourceGiveaway`
    ...
    def __init__(self, source: str, *, api_kwargs: Optional[JSONDict] = None):
        ...
        self.source: str = enum.get_member(
            constants.ChatBoostSources, source, source)
...
class ChatBoostSourceGiveaway(ChatBoostSource):
    ...
    __slots__ = ("giveaway_message_id", "is_unclaimed",
                 "prize_star_count", "user")
...
class ChatBoost(TelegramObject):
    ...
    def __init__(
        ...
        *,
        ...
        self._id_attrs = (self.boost_id, self.add_date,
                          self.expiration_date, self.source)
        self._freeze()
    ...
    def de_json(
        ...
        data["expiration_date"] = from_timestamp(
            data["expiration_date"], tzinfo=loc_tzinfo)
...
class ChatBoostRemoved(TelegramObject):
    ...
    def __init__(
        ...
        *,
        ...
        self._id_attrs = (self.chat, self.boost_id,
                          self.remove_date, self.source)
        self._freeze()
    ...
    def de_json(
        ...
        data["source"] = ChatBoostSource.de_json(data.get("source"), bot)
        loc_tzinfo = extract_tzinfo_from_defaults(bot)
        data["remove_date"] = from_timestamp(
            data["remove_date"], tzinfo=loc_tzinfo)
