...
class SummaryReporter:
    ...
    def __init__(self, coverage: Coverage) -> None:
        ...
        if self.output_format not in {"text", "markdown", "total"}:
            raise ConfigError(
                f"Unknown report format choice: {self.output_format!r}")
    ...
    def _report_text(
        ...
        max_n = max([max_n] + [len(line[header.index("Cover")]) +
    ...
    def _report_markdown(
        ...
        header_items = [formats[item].format(
            item, name_len=max_name, n=max_n) for item in header]
        header_str = "".join(header_items)
        ...
        for values in lines_values:
            ...
            line_items = [
                formats[item].format(str(value).replace(
                    "_", "\\_"), name_len=max_name, n=max_n-1)
    ...
    def tabular_report(self) -> None:
        ...
        if self.branches:
            total_line += [self.total.n_branches,
