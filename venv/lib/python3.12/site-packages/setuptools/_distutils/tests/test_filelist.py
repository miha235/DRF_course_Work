...
class TestFileList:
    ...
    def test_translate_pattern(self):
        # not regex
        assert hasattr(translate_pattern(
            'a', anchor=True, is_regex=False), 'search')
        ...
        assert hasattr(translate_pattern(
            'a', anchor=True, is_regex=True), 'search')
    ...
    def test_process_template(self, caplog):
        ...
        # recursive-exclude
        file_list = FileList()
        file_list.files = ['a.py', mlp(
            'd/b.py'), mlp('d/c.txt'), mlp('d/d/e.py')]
        ...
        file_list = FileList()
        file_list.files = ['a.py', mlp(
            'd/b.py'), mlp('d/d/e.py'), mlp('f/f.py')]
