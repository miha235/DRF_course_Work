...
class SwaggerAutoSchema(ViewInspector):
    ...
    def get_operation(self, operation_keys=None):
        ...
        assert security is None or isinstance(
            security, list), "security must be a list of security requirement objects"
    ...
    def get_response_serializers(self):
        ...
        manual_responses = OrderedDict((str(sc), resp)
    ...
    def get_summary_and_description(self):
        ...
        if description is None:
            description = self._sch.get_description(
                self.path, self.method) or ''
